...
function nv_theme_samples_main ( $sql_data, $now_page, $db)
{
...
function nv_theme_onbai_test( $key, $suggest, $data, $info, $do , $checkdapandoc = false, $thoigian)
{
	...
	{
		if ( $i == ( $max + 1 ) )
		$xtpl->assign( 'LASTINFO', "<a href=\"javascript:void(0);\" title=\"".$suggest[count( $data )] ."\"; \"><img src=\"".NV_BASE_SITEURL . "themes/" . $module_info['template'] . "/images/ochu/application.png\" border=\"0\" />" );
